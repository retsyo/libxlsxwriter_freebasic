...
function main() as Integer
    ...
    var workbook  = new_workbook("chart_doughnut.xlsx")
     ...
     * Chart 1: Create a simple doughnut chart.
     '/
    var chart = workbook_add_chart(workbook, LXW_CHART_DOUGHNUT)
    ...
    Dim As lxw_chart_point ptr points(0 to 4)  = {@point1, _
                                 @point2, _
                                 @point3, _
                                 NULL}
